            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#nos_services">Nos services</a></li>
                        <li class="nav-item"><a class="nav-link" href="site de mise en relation techniciens&clients.html#techniciens">je suis un technicien</a></li>
                    ...
                    <div class="d-flex ms-lg-3">
                        ...
                        <a href="inscription_client.php" class="btn btn-primary">Inscription</a>
                    </div>
                </div>
            </div>
        </nav>
