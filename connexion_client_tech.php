            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="card shadow-sm p-4">
                        ...
                        <?php endif; ?>
                        <form action="connexion_client_tech.php" method="POST">
                            <div class="mb-3">
                            ...
                            <p class="text-center mt-3">Pas encore de compte ? <a href="inscription_client_tech.php">Inscrivez-vous</a></p>
                            <p class="text-center mt-2"><a href="technicien.php">Retour à l'accueil</a></p>
                        </form>
                    </div>
                </div>
            </div>
